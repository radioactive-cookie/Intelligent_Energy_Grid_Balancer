...
| Service  | URL                                                         |
|----------|-------------------------------------------------------------|
| Frontend | https://intelligent-energy-grid-balancer.vercel.app/        |
| Backend  | https://intelligent-energy-grid-balancer-fdxg.onrender.com  |
| WS       | wss://intelligent-energy-grid-balancer-fdxg.onrender.com/ws |
| Health   | https://intelligent-energy-grid-balancer-fdxg.onrender.com/health |
...
## 📘 Backend Documentation (Merged from `backend/README.md`)
